...
function rl_meta_box_callback($post) {
    ...
    <div id="rl-language-files-wrapper">
        ...
        <p>
            Upload a file for each selected language.
        </p>
        ...
        foreach ($languages as $slug => $label) {
            ...
            <div
                class="rl-language-file-row"
                data-language="<?php echo esc_attr($slug); ?>"
            ...
            >
                ...
                <input
                    type="hidden"
                    id="rl_file_<?php echo esc_attr($slug); ?>"
                    name="rl_file_<?php echo esc_attr($slug); ?>"
                    value="<?php echo esc_attr($file_id); ?>"
                >

                <button
                    type="button"
                    class="button rl-upload-file"
                ...
                <div
                    id="rl_file_preview_<?php echo esc_attr($slug); ?>"
...
function rl_save_image_meta($post_id)
{
    ...
    if (
        isset($_POST['rl_image'])
    ) {

        update_post_meta(
            $post_id,
            '_rl_image',
            intval($_POST['rl_image'])
        );
    }
...
function rl_validate_resource($post_id)
{
    ...
    if (
        empty($_POST['tax_input']['resource_topic'])
    ) {
        ...
        foreach ($selected_languages as $term_id) {
            ...
            if (
                ...
                wp_die(
                    ...
                    $language_map[$slug]
                    . ' language selected but no file uploaded.',
